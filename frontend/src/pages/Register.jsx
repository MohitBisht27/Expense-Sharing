    ...
    <div className="bg-auth-page min-h-screen flex">
      ...
      >
        ...
        <div className="relative animate-slide-up" style={{ zIndex: 1, textAlign: 'center', maxWidth: '28rem', width: '100%' }}>
          ...
          <h1 style={{ fontSize: '2.25rem', fontWeight: 800, color: '#1e293b', marginBottom: '1rem', lineHeight: 1.2, letterSpacing: '-0.025em' }}>
      ...
      {/* ── Right Form Panel ──────────────────────────────────── */}
      <div className="flex-1 flex flex-col items-center justify-center px-4 py-10" style={{ overflowY: 'auto' }}>
        {/* Mobile logo */}
        <div className="flex items-center gap-3 mb-8 animate-slide-down" style={{ display: 'none' }}>
          <div
            style={{
        ...
        <style>{`
          @media (max-width: 1023px) {
            .mobile-logo-register { display: flex !important; }
          }
        `}</style>
        <div className="mobile-logo-register items-center gap-3 mb-8 animate-slide-down" style={{ display: 'none' }}>
          <div
            style={{
              width: '2.75rem', height: '2.75rem', borderRadius: '1rem',
              background: 'linear-gradient(to bottom right, #6366f1, #7c3aed)',
        ...
        <div className="w-full animate-slide-up" style={{ maxWidth: '28rem' }}>
          <div className="card-elevated rounded-2xl card-interactive" style={{ padding: '1.5rem' }}>
            <div className="mb-7">
              <h2 style={{ fontSize: '1.5rem', fontWeight: 800, color: '#1e293b', marginBottom: '0.5rem', letterSpacing: '-0.025em' }}>
                Create your account
              </h2>
              <p className="text-sm text-slate-500 font-medium">
                Join SplitWise and start tracking expenses
              </p>
            </div>
            <RegisterForm />
